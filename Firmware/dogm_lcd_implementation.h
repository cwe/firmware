...
static void lcd_implementation_drawmenu_generic_RAM(uint8_t row, const char* pstr, char pre_char, char post_char)
{
    char c;
...
static void lcd_implementation_write(char c) {}
